...
# calculate diversity indexes by sample
shan <- apply(ps_specie_raref, 1, vegan::diversity, index = 'shannon') #asymptotically normal distribution
chao1  <- apply(round(sp_ps), 1, fossil::chao1)
...
```{r}
aitchison <- vegan::vegdist(clr_species, method = "euclidean") 
```
